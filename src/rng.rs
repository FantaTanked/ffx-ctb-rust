...
const RNG_CONSTANTS_2: [i64; 68] = [
    10259, 24563, 11177, 56952, 46197, 49826, 27077, 1257, 44164, 56565, 31009, 46618, 64397,
    46089, 58119, 13090, 19496, 47700, 21163, 16247, 574, 18658, 60495, 42058, 40532, 13649, 8049,
    25369, 9373, 48949, 23157, 32735, 29605, 44013, 16623, 15090, 43767, 51346, 28485, 39192,
    40085, 32893, 41400, 1267, 15436, 33645, 37189, 58137, 16264, 59665, 53663, 11528, 37584,
    18427, 59827, 49457, 22922, 24212, 62787, 56241, 55318, 9625, 57622, 7580, 56469, 49208, 41671,
    36458,
];
...
mod tests {
    ...
    fn matches_python_initial_values_for_default_seed() {
        ...
        assert_eq!(
            ...
            &[
                20396785, 1481230243, 8633225, 474117860, 1881763622, 942883522, 1757343272,
                1778181219
            ]
        );
    }
    ...
    fn matches_python_rolls_for_small_seeds() {
        ...
        assert_eq!(
            &tracker.initial_values()[..8],
            &[
                1201298776, 1475124949, 222143696, 843409743, 761293752, 600613063, 934824559,
                1593865543
            ]
        );
        assert_eq!(
        ...
        assert_eq!(
            &tracker.initial_values()[..8],
            &[
                1010106368, 1010075625, 1579262877, 136687124, 1176028994, 792663207, 253241474,
                1300183350
            ]
        );
        assert_eq!(
