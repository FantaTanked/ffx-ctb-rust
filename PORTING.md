...
- Action effects are still intentionally shallow: common ranks plus upstream-driven status/buff/heal/delay effects are modeled, but damage formulas, full target-selection parity, equipment mechanics, elemental affinity mechanics, and event-specific AI remain to be ported for parity.
